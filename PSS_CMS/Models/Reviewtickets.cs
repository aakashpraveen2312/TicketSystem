...
namespace PSS_CMS.Models
{
    public class Reviewtickets
    {
        ...
        // For the Html div tags

        //public int TC_USERID { get; set; }
        //public int TC_COMPANYID { get; set; }
        //public int TC_PROJECTID { get; set; }
        //public List<Recenttickets> Tickets { get; set; }

    }

    public class APIResponseReviewticketsHTML
    {
        public List<Recenttickets> Conversations { get; set; }
    }
