...
namespace PSS_CMS.Controllers
{
    ...
    public class UseradminmappingController : Controller
    {
        ...
        public async Task<ActionResult> List(string Role,string USERID,string Name)
        {
            Session["Name"] = Name;
        ...
        public async Task<ActionResult> ListProject(string Role, string USERID, string Name)
        {
        ...
        //[HttpPost]
        //public async Task<ActionResult> CheckedValueProject(List<string> selectedItems, Useradminmap useradminmap)
        //{
        //    try
        //    {
