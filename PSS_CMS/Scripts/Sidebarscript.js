...
function setupEvents() {
    ...
    const configItems = document.querySelectorAll('.menu-links .nav-link:nth-child(2)');

    const configMenu1 = document.querySelector('.menu-links .nav-link:nth-child(3)');
    const configItems1 = document.querySelectorAll('.menu-links .nav-link:nth-child(4), .menu-links .nav-link:nth-child(5)');
